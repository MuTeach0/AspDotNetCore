...
{
    public string Pay(decimal amount) => $"Payment of ${amount} was processed using Stripe!";
}

public class PayPalPayment : IPaymentProvider
{
    public string Pay(decimal amount) => $"Payment of ${amount} was processed using PayPal!";
}