using M02.UrlQueryStringVersioningController.Models;

namespace M02.UrlQueryStringVersioningController.Data;
...
public class ProductRepository
{
    ...
    // public List<Product> GetAllProductsPage(int page = 1, int pageSize = 10)
    // {
    ...
    // }
     ...
     public Product? GetProductById(Guid id) =>
         _products.FirstOrDefault(p => p.Id == id) ?? null;
    ...
    //     _reviews.FirstOrDefault(r => r.ProductId == productId && r.Id == reviewId) ?? null;
