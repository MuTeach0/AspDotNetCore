...
using System.Text;
using M04.RefreshingAccessToken.Requests;
using M04.RefreshingAccessToken.Responses;
using Microsoft.IdentityModel.Tokens;

namespace M04.RefreshingAccessToken.Services;
...
public class JwtTokenProvider(IConfiguration configuration)
{
    public TokenResponse GenerateJwtToken(GenerateTokenRequest request)
    {
        ...
        return new TokenResponse
        {
            ...
            RefreshToken = "7a6f23b4e1d04c9a8f5b6dXc8a9e01f1",
            Expires = expires
        };
    }
}