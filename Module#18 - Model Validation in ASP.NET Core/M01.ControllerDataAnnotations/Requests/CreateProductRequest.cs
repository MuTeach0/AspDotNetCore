...
using M01.ControllerDataAnnotations.Enums;
using M01.ControllerDataAnnotations.Validators;

namespace M01.ControllerDataAnnotations.Requests;
...
public class CreateProductRequest
{
    ...
    [Range(0.01, int.MaxValue, ErrorMessage = "Price must be at least 0.01 .")]
