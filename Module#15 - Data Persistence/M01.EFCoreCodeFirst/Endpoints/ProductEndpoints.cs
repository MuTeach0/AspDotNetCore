...
using M01.EFCoreCodeFirst.Responses;
using M01.EFCoreCodeFirst.Models;
using Microsoft.AspNetCore.Http.HttpResults;
using M01.EFCoreCodeFirst.Requests;

namespace M01.EFCoreCodeFirst.Endpoints;
...
public static class ProductEndpoints
{
	...
	private static async Task<IResult> GetPaged(ProductRepository repository, int page = 1, int pageSize = 10)
	{
		...
		var products = await repository.GetAllProductsPageAsync(page, pageSize);
	...
	private static async Task<Results<Ok<ProductResponse>, NotFound<string>>> GetProductById(Guid productId, ProductRepository repository, bool includeReviews = false)
	{
	...
	private static async Task<IResult> CreateProductReview(Guid productId, CreateProductReviewRequest request, ProductRepository repository)
	{
