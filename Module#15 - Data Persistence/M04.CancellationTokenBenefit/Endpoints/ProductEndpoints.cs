...
using M04.CancellationTokenBenefit.Requests;
using M04.CancellationTokenBenefit.Responses;
...
public static class ProductEndpoints
{
		...
		CancellationToken ct = default)
	{
		...
		var products = await repository.GetAllProductsPageAsync(page, pageSize, ct);

		var pageResult = PageResult<ProductResponse>.Create(
			ProductResponse.FromModels(products), totalCount, page, pageSize);
